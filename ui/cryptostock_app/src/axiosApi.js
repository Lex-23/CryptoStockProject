...
const axiosInstance = axios.create({
    ...
    timeout: 5000,
    headers: {
        'Authorization': localStorage.getItem('access_token') ? JWTPrefix + localStorage.getItem('access_token') : null,
                ...
                if (refreshToken){
                    ...
                    if (tokenParts.exp > now) {
                        ...
                        .then((response) => {
                            ...
                            originalRequest.headers['Authorization'] = JWTPrefix + response.data.access;
